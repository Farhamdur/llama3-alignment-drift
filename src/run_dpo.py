...
def main():
    ...
    ap.add_argument("--train_jsonl", type=str, default="data_out/dpo_pku/dpo_train.jsonl")
    ap.add_argument("--val_jsonl", type=str, default="data_out/dpo_pku/dpo_eval.jsonl")
    ap.add_argument("--save_dir", type=str, default="outputs/dpo-helpful-safety")
    ...
    ap.add_argument("--max_length", type=int, default=3072)  # belongs on SFTTrainer
    ...
    ap.add_argument("--resume_adapter", type=str, default="outputs/lora-helpful-safety")
    ...
    train_ds = Dataset.from_list(load_jsonl(args.train_jsonl))
    val_ds = Dataset.from_list(load_jsonl(args.val_jsonl))
